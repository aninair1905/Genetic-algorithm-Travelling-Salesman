...
//Number of threads can be configured as per computer 
#define NUM_THREADS 256   
#define BLOCKS 1024

// must be number of cities being read in file
#define NUM_CITIES 194									
#define MAX_COORD 250		
// this should match #threads, at least in the beginning
#define POPULATION_SIZE NUM_THREADS
...
{
    int td = blockDimint tid = blockDim.x * blockIdx.x + threadIdx.x;
